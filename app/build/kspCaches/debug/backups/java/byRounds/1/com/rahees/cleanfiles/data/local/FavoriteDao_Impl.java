...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`id`,`path`,`name`,`isDirectory`,`addedAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__preparedStmtOfDeleteFavoriteByPath = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
  ...
  @Override
  public Object deleteFavoriteByPath(final String path,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteFavoriteByPath.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteFavoriteByPath.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpId,_tmpPath,_tmpName,_tmpIsDirectory,_tmpAddedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
